...
export default function Contact() {
  return (
    <section className="w-full min-h-[80vh] flex flex-col md:flex-row items-center justify-center border-t-2 border-[#e6c49a]" style={{ backgroundColor: '#2E463F' }}>
      {/* Left: Heading */}
      <div className="w-full md:w-1/2 flex items-start md:items-center justify-center md:justify-end px-8 py-16 md:py-0">
        <h1 className="text-[#f3f3e6] text-6xl md:text-7xl font-light">Contact Us</h1>
      </div>
      {/* Right: Form */}
